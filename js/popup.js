...
function popup1() {
    CreativaPopup.create('Feel free to DM me    amtrixi#0001 &#10084', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">amtrixi#0001</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://discord.gg/byKSexHfvp" style="color: #ADD8E6;">https://discord.gg/byKSexHfvp</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("amtrixi#0001");
    setTimeout(function() {
